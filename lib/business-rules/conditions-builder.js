(function(reNamespace, $) {
  ...
  ConditionsBuilder.prototype = {
    ...
    collectData: function() {
      ...
      return this.collectDataFromNode(this.element.conditionsHtml);
    },
    ...
    collectDataFromNode: function(element) {
      ...
      if(element.classList.contains("conditional")) {
        klass = element.querySelectorAll(".all-any-none-wrapper > .all-any-none")[0].value;
